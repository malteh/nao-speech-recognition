...
object Converter {
  ...
  /**
   * Erzeugt einen Call um die Augen des Nao für 3 Sekunden in einer zufälligen Farbe aufleuchten zu lassen
  ...
  /**
   * Erzeugt einen Call um den K�rper des Nao locker zu schalten
   */
  def loose = Call('ALMotion, 'setStiffnesses, List("Body", 0.0f)) :: Nil

  /**
   * Erzeugt einen Call um den K�rper des Nao steif zu schalten
   */
